...
public interface BookingRepository extends JpaRepository<Booking, Long> {
        ...
        List<Booking> findByClientIdOrderByAvailabilityDateDescAvailabilityStartTimeDesc(Long clientId);
        ...
        @Query("SELECT b FROM Booking b " +
                        ...
                        "FUNCTION('TIMESTAMP', a.date, a.startTime) BETWEEN :from AND :to")
